...
**IMPORTANT: Discover mode is for thinking, not implementing.** You may read files, search code, and investigate the codebase. You must NEVER write code or implement features. You MAY create or update reespec artifacts (brief.md, decisions.md) if the human asks — that is capturing thinking, not implementing.
