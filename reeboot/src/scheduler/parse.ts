 ...
 */
export function parseHumanInterval(s: string): number | null {
 ...
 */
export function detectScheduleType(value: string): ScheduleDescriptor {
 ...
 */
export function computeNextRun(task: TaskForNextRun): string | null {
